...
let task8 = document.querySelector('.one');
task8.innerHTML = 'Hello World';
...
let task10 = document.querySelector('.three');
task10.innerHTML = '<h3>Hello Wold</h3>';
...
let task11 = document.querySelector('.four');
task11.innerHTML = '<h4>Hello world</h4>';
task11.innerHTML+= '<p>Hello world</p>';

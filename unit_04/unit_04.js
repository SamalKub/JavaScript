...
function f8() {
    ...
    out8.innerHTML = '<button class="b-81">Push</button>';

    let i81 = document.createElement('input');
    i81.setAttribute('type', 'text');
    i81.setAttribute('class', 'i-81');
    out8.append(i81);
...
function f20(e) {
    ...
    out20.innerHTML = username.value + ' ' + password.value;

...
function f3() {
    ...
    document.querySelector('.out-3').innerHTML = length;
}
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = s;
}

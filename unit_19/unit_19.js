...
function t1(e) {
    let out = e.target.innerText;
    return toOut('.out-1', out);
}
...
function t5(e) {
    let arr = document.querySelector('.div-5');
    console.log(e);
    if (arr.className.includes('active')){
        arr.classList.remove('active');
    }
    else {
        arr.classList.add('active');
    }
    toOut('.out-5', e.toElement.classList);
}
...
function t19(e) {
    ...
    console.log(e);
    div.innerHTML = e.target.classList;
}
